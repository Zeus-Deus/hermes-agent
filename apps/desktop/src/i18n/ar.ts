...
export const ar = defineLocale({
  ...
  agents: {
    openAsTab: 'فتح كعلامة تبويب',
    liveUnavailable: 'حالة التشغيل غير متاحة',
    inventoryUnavailable: 'حدّث هذه البوابة لعرض جلساتها وروبوتاتها.',
    historyShifted: 'تغيّرت الجلسات أثناء القراءة؛ جارٍ التحديث.',
    sessionsTab: 'الجلسات',
    treeTab: 'شجرة التوليد',
    overviewSubtitle: 'نشاط جلسات Hermes عبر المصادر المسجّلة.',
    ...
    recentActivityHint:
      'تبقى الجلسات قيد التشغيل والتي تنتظر إدخالاً ظاهرة. تظهر الجلسات الأخرى لمدة 15 دقيقة بعد النشاط. اختر «كل الجلسات» لاستعراض السجل.',
    needsYou: 'بحاجة إليك',
    working: 'قيد العمل',
    unread: 'غير مقروء',
    idle: 'غير نشط',
    stale: 'بيانات قديمة',
    noSessions: 'لا توجد جلسات مطابقة',
    selectSession: 'اختر محادثة لمعاينتها.',
    ...
    coverageNote: 'تغطي الحالة المباشرة عمليات Hermes المتصلة فقط. غير نشط لا تعني أن العمل اكتمل.',
    promptHint: 'افتح المحادثة للرد على طلبات الموافقة أو الأسئلة.',
    history: 'تغطية السجل',
    ready: 'جاهز',
    onDemand: 'عند الطلب',
    offline: 'غير متصل',
    ...
    allQuietHint:
      'تبقى الجلسات قيد التشغيل أو التي تنتظر إدخالاً هنا. تختفي المحادثات المنتهية بعد 15 دقيقة؛ اختر «كل الجلسات» لاستعراض السجل.',
    needYouCount: count => `${count} بحاجة إليك`,
    workingCount: count => `${count} قيد العمل`,
