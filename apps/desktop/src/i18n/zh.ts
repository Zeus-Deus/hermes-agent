...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      themeSharedNote: '所有配置文件和网关共享——选择一次，随处生效。',
      themeScopeTitle: '主题范围',
      themeScopePerProfile: '按配置文件',
      themeScopeShared: '共享',
      themeScopePerProfileDesc: '每个配置文件和网关记住各自的主题与浅色/深色模式，切换配置文件时外观随之切换。',
      themeScopeSharedDesc: '整个应用使用同一主题与浅色/深色模式，对所有配置文件和网关生效。其余外观设置本就是共享的。',
