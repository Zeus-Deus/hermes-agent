...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      themeSharedNote: '所有設定檔和閘道共用——選擇一次，隨處生效。',
      themeScopeTitle: '主題範圍',
      themeScopePerProfile: '依設定檔',
      themeScopeShared: '共用',
      themeScopePerProfileDesc: '每個設定檔和閘道記住各自的主題與淺色/深色模式，切換設定檔時外觀隨之切換。',
      themeScopeSharedDesc:
        '整個應用程式使用同一主題與淺色/深色模式，對所有設定檔和閘道生效。其餘外觀設定本就是共用的。',
  ...
  agents: {
    ...
    sessionsTab: '工作階段',
    treeTab: '派生樹',
    overviewSubtitle: '已註冊來源的 Hermes 對話活動。',
    ...
    recentActivityHint:
      '執行中和等待輸入的對話會持續顯示。其他對話在最後活動後的15分鐘內顯示。選擇「所有對話」查看歷史記錄。',
    needsYou: '需要你',
    working: '工作中',
    unread: '未讀',
    idle: '閒置',
    stale: '已過期',
    noSessions: '沒有符合的工作階段',
    selectSession: '選擇對話以查看預覽。',
    ...
    unknown: '未知',
    loadMore: '載入更多',
    coverageNote: '即時狀態僅涵蓋已連線的 Hermes 程序。閒置不代表已完成。',
    promptHint: '開啟對話以回應核准或問題。',
    history: '歷史涵蓋範圍',
    ready: '就緒',
    onDemand: '按需連線',
    offline: '離線',
    ...
    partial: '部分可用',
    allQuiet: '一切安靜',
    allQuietHint: '執行中和等待輸入的對話會保留在此。已完成的對話在15分鐘後消失；查看歷史請切換到「所有對話」。',
    needYouCount: count => `${count} 個需要你`,
    workingCount: count => `${count} 個工作中`,
    closePreview: '關閉預覽',
    replyPlaceholder: '回覆…',
    noPreview: '暫無預覽。',
